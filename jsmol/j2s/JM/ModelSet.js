...
var d = (specInfo == null || isSU ? null : (specInfo)[1]);
var packing = (d == null ? NaN : d.floatValue());
if (specInfo != null && !isSU) specInfo = (specInfo)[0];
...
if (uc.checkPeriodic(this.ptTemp1, NaN)) bs.set(i);
}}
return bs;
...
function(modelIndex, rot, isdx){
if (modelIndex < 0 || modelIndex >= this.mc || this.vibrations == null) return;
if (this.am[modelIndex].isJmolDataFrame) modelIndex = this.am[modelIndex].dataSourceFrame;
var info = this.getModelAuxiliaryInfo(modelIndex);
if (rot == null) {
...
this.rotateModelSpinVectors(modelIndex, rot, false);
...
v.rotateSpin(matInv, rot, drot, this.at[i]);
}
...
if (this.unitCells[modelIndex] != null) this.unitCells[modelIndex].setSpinAxisAngle(aa);
}, "~N,JU.M3,~B");
