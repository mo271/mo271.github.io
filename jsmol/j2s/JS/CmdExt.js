...
var len = 0;
for (var i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i + 1)) {
var v = this.vwr.ms.getVibration(i, false);
if (v == null) bs.clear(i);
 else len = Math.max(len, v.length());
}
if (len == 0) return "";
minXYZ = JU.P3.new3(-len, -len, -len);
maxXYZ = JU.P3.new3(len, len, len);
var lst =  new JU.Lst();
for (var i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i + 1)) {
var v = this.vwr.ms.getVibration(i, false);
var found = false;
...
startScript = "zap 2.1;select " + JU.Escape.eBS(bs) + ";\n ";
...
if (tok == 1715472409 || tok == 1095241729) {
...
}parameters =  Clazz.newArray(-1, [bs, dataX, dataY, dataZ, minXYZ, maxXYZ, factors, center, format, propData, Float.$valueOf(1)]);
...
this.vwr.ms.setJmolDataFrame(startScript, modelIndex, modelCount - 1);
...
e.sm.loadShape(31);
if (isSpinPointGroup) {
script = ";set symmetryhm;draw spin pointgroup;var name = {2.1}.pointgroup().hmName;set echo hmname 100% 100%;set echo hmname RIGHT;set echo hmname model 2.1;echo @name;";
e.runScript(script);
}if (isSplit) e.runScript("frame 1.1 2.1 split;");
...
if (packing >= 0) this.vwr.getModelkit(false).packUnitCell(sym, this.vwr.getModelUndeletedAtomsBitSet(this.vwr.am.cmi), packing);
...
var odata = (property == null || tok == (1086325010) || tok == (1145047311) || tok == (1111490843) ? this.e.getBitsetProperty(bs, null, tok, null, null, property, null, false, 2147483647, false) : this.vwr.getDataObj(property, bs, 1));
...
;//5.0.1-v7 Wed Dec 31 19:23:52 CST 2025
