...
if (isInfo && JU.AU.isAP(o)) {
var uc = this.vwr.getSymTemp().getUnitCell(o, false, null);
...
x = args[1];
if (x.tok == 4 && !"string".equalsIgnoreCase(format)) {
x = args[0];
format = "string";
}} else {
x = args[0];
...
bsSelected = this.vwr.ms.getAtoms(tok,  Clazz_newArray(-1, [uc, isDistance ? Double.$valueOf(distance) : null]));
break;
}var plane = null;
var pt = null;
var pts1 = null;
...
;//5.0.1-v7 Wed Dec 31 09:26:49 CST 2025
