...
;//5.0.1-v7 Wed Dec 31 09:03:40 CST 2025
Clazz_declarePackage("JS");
...
;//5.0.1-v7 Wed Dec 31 15:00:35 CST 2025
Clazz_declarePackage("JS");
Clazz_load(["J.api.JmolScriptManager", "JU.Lst"], "JS.ScriptManager", ["java.util.Hashtable", "JU.AU", "$.PT", "$.Rdr", "$.SB", "J.api.Interface", "J.i18n.GT", "JS.ScriptQueueThread", "JU.Elements", "$.Logger", "JV.FileManager", "$.JC"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.vwr = null;
this.eval = null;
this.evalTemp = null;
